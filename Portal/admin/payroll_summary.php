...
//update summary
  ...
  $sqla = "SELECT * FROM payroll_coverage_table WHERE pay_code='$pc'";
  ...
  while($row = $queryz->fetch_assoc()){
    ...
    if($row['payroll_status']==0){
      ...
      $sqlc ="SELECT * FROM employees e WHERE date_hired < '$Edate' AND e.employee_id NOT IN (SELECT employee_id FROM payroll_summary WHERE pay_code='$pc')";

      $querys = $conn->query($sqlc);
        ...
        <?php include 'includes/sidebar.php'?>
                  ...
                  <div class="pcoded-content">
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#">Payroll Summary</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                      ...
                      <!-- Page-header end -->
                        ...
                        ?>
                        <br>
                        <h4 class="text-center">Payroll summary from <?php
                        ...
                        $date2=date_create($Edate);
                         ...
                         echo date_format($date1,"M d, Y")." to ".date_format($date2,"M d, Y"); ?></h4>
                        <br>
                            <!-- Main-body start -->
                            <a href="payroll_list.php"><button type="button" class="btn btn-mat waves-effect waves-light btn-success" ><i class="fa fa-arrow-left"></i>Back</button></a>
                        ...
                        <!-- Main-body start -->
                                    ...
                                    <tbody>
							    	 ...
							    	 if(isset($_POST['depts'])) { 
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo "&#8369; ".round(($income-$Tdeduction),2); ?></td>
                                        <td>
                                           <button class="btn btn-success btn-sm view btn-flat" data-id="<?php echo $row['psid']; ?>"><i class="fa fa-eye"></i> View</button>
                                        </td>
                                        </tr>
                                         <?php }    ?>
                            ...
                            </div><input type="hidden" id="rowcount" value="<?php echo $count; ?>" >
