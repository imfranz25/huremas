              ...
              <div class="pcoded-inner-content">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <button type="button" class="btn btn-mat waves-effect waves-light btn-success float-right" data-toggle="modal" data-target="#addTask">
                      ...
                      <table id="table1" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody id="tbody">
                          ...
                          <tr>
                            ...
                            <td>
                              <?php echo $row['lastname'].' '.$row['suffix'].' '.$row['firstname'].'  '.$row['middlename']; ?>
                            </td>
                            <td>
                              <?php 
                            ...
                            <td class="text-center">
                              ...
                              <div class="dropdown-menu" style="">
                                <a class="dropdown-item view_task" href="javascript:void(0)" data-id="<?php echo $row['tid'] ?>">
                                  <i class="fa fa-eye"></i>View Task
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item edit_task" href="javascript:void(0)" data-id="<?php echo $row['tid'] ?>">
                                  <i class="fa fa-edit"></i>Edit
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item view_progress"  data-id = '<?php echo $row['tid'] ?>' data-task = '<?php echo ucwords($row['task']) ?>'   href="javascript:void(0)" onclick='getids()' >
                                  <i class="fa fa-eye"></i>View Progress
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item delete_task text-danger" href="javascript:void(0)" data-id="<?php echo $row['tid'] ?>">
...
$(document).ready(function() {
  ...
  $(document).on('click','.view_progress',function(e){
    e.preventDefault();
    $('#viewProg').modal('show');
    var id = $(this).data('id');
    getRow2(id);
