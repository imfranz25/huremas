          ...
          <div class="pcoded-content">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button type="button" class="btn btn-mat waves-effect waves-light btn-success float-right" data-toggle="modal" data-target="#addDTR" >
                  ...
                  <div class="table-responsive">
                    <table id="table1" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          <td>
                            <?php echo date('M d, Y',strtotime($row['time_in']));   ?>
                          </td>
                          <td><?php echo $row['name']; ?></td>
                          <td><?php echo $row2['title']; ?></td>
                          <td><?php echo $row2['description']; ?></td>
                          <td>
                            <?php echo date('H:m:s',strtotime($row['time_in']));?>
                          </td>
                          <td>
