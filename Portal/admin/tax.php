<div class="card">
  <div class="card-header">
    ...
    <button type="button" class="btn btn-mat waves-effect waves-light btn-danger float-right" data-toggle="modal" id="deleteAlltax">
      <i class="fa fa-trash"></i>Delete
    </button>
    <button type="button" class="btn btn-mat waves-effect waves-light btn-success float-right mx-2" id="add_tax" data-toggle="modal" data-target="#taxNew">
        ...
        <table id="table3" class="table table-striped table-bordered" style="width:100%">
          ...
          <tbody id="tbody_tax">
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-default btn-sm btn-flat border-success wave-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Action</button>
                <div class="dropdown-menu" style="">
                  <a class="dropdown-item edittax" href="javascript:void(0)" data-id="<?php echo $row['tid'] ?>">
                    <i class="fa fa-edit"></i>Edit
                  </a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item deletetax text-danger" href="javascript:void(0)" data-id="<?php echo $row['tid'] ?>">
                    <i class="fa fa-trash"></i>Delete
                  </a>
                </div>
              </td>
