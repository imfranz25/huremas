<?php 
  ...
  //task completed
  $sql = "SELECT COUNT(*) as counts FROM task 
          WHERE completed > '$F_month' 
          AND completed < '$L_month' ";
  $query = $conn->query($sql);
  ...
  //task overdue
  $sql = "SELECT COUNT(*) as counts FROM task 
          WHERE due_date > '$F_month' 
          AND due_date < '$L_month' ";
  $query = $conn->query($sql);
  $row = $query->fetch_assoc();
  $dues = $row['counts'];
                        ...
                        <div class="col-xl-3 col-md-6">
                          <div class="card">
                            <div class="card-block">
                              <div class="row align-items-center">
                                <div class="col-8">
                                  <h4 class="text-c-purple"><?php echo $empcount;?></h4>
                            ...
                            <div class="card-footer bg-c-purple">
                              <div class="row align-items-center">
                                <div class="col-9">
                                  <a href='employee.php?page=employee_list'><p class="text-white m-b-0">More Info</p></a>
                                </div>
                              ...
                              <div class="row align-items-center">
                                <div class="col-8">
                                  <h4 class="text-c-green">
                                    <?php echo $goalcount." out of ".$dues;?>
                                  </h4>
                                  <h6 class="text-muted m-b-0">Task Comp. (
                                    <?php echo $month; ?>)
                                  </h6>
                                </div>
                                <div class="col-4 text-right">
