        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group form-default text-center">
                <a href="employee.php?page=new_employee_cnt"><button type="button" class="btn btn-mat waves-effect waves-light btn-success" ><i class="fa fa-plus"></i>Contractual</button></a>
                <br>
                <hr>
                <a href="employee.php?page=new_employee_jo"><button type="button" class="btn btn-mat waves-effect waves-light btn-success" ><i class="fa fa-plus"></i>Job Order</button></a>
              </div>
                    ...
                    <div class="col-md-6 border-right">
                        ...
                        <div class="form-group ">
                                ...
                                <div id="checkBoxes" class="multipleSelection">
                                  ...
                                  $i=0;
                                  while($srow = $query->fetch_assoc()){
                                    if ($srow['deduction_type'] =="Fixed Amount" ||
                                                    $srow['deduction_type'] =="Hour Amount") {
                                                    $amt_rate = "&#8369; ".number_format($srow['amount_rate'],2);
                                                }else{$amt_rate = $srow['amount_rate']."%";}
                                   ?>

                                    <label for="">
                                        &ensp;<input type="checkbox" class="myCheckbox" value="<?php echo $srow['id']; ?>"  id="<?php echo 'cb'.$srow['id']; ?>" name="cb<?php echo $i; ?>"   />
                ...
                <div class="row ">
                    <div class="col-md-6  ">
                        <div class="form-group">
                            ...
                            <input type="text" id="view_firstname" class="form-control form-control-sm" readonly >
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Middle Name</label>
                            <input type="text" id="view_middlename" class="form-control form-control-sm" readonly>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Last Name</label>
                            <input type="text" id="view_lastname" class="form-control form-control-sm" readonly >
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Suffix</label>
                            <input type="text" id="view_suffix" readonly class="form-control form-control-sm" >
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Date of Birth</label>
                            <input type="date" id="datepicker_view"  class="form-control form-control-sm" readonly >
                        </div>

                        <div class="form-group">
                            <label for="" class="control-label">Sex</label>
                            <input type="text"  id="gender_view" class="form-control form-control-sm" readonly >
                        </div>
                        
                        <div class="form-group">
                            <label class="control-label">Address</label>
                            <textarea class="form-control" rows="2" id="view_address" readonly></textarea>

                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Mobile Number</label>
                            <input type="text" id="view_mobile" readonly class="form-control form-control-sm" >
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Contact Number</label>
                            <input type="text" id="view_contact" readonly class="form-control form-control-sm" >
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label">Email</label>
                            <input type="email" id="view_email" class="form-control form-control-sm" readonly >
                        </div>
                        
                        <div class="form-group">
                            <label for="" class="control-label">Category</label>
                            <input type="text" id="view_category" class="form-control form-control-sm" readonly >
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">Department</label>
                            <input type="text" id="view_department1" class="form-control form-control-sm" readonly >
                        </div>

                        <div class="form-group">
                            <label for="" class="control-label">Designation</label>
                            <input type="text" id="view_position" class="form-control form-control-sm" readonly >
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="view_date_hired" class="form-control form-control-sm" readonly >
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-md-6 border-right">
                        <div class="form-group">
                            ...
                            <input type="text" id="view_tin" class="form-control form-control-sm" readonly>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label ">SSS</label>
                            <input type="text" id="view_sss"  class="form-control form-control-sm" readonly>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label ">PAGIBIG</label>
                            <input type="text" id="view_pagibig" class="form-control form-control-sm" readonly>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label ">PHILHEALTH</label>
                            <input type="text" readonly id="view_phealth" class="form-control form-control-sm" >
                        </div>
                    ...
                    <div class="col-md-6 border-right">
                        ...
                        <div class="form-group">
                            <label id="income" for="" class="control-label">Basic Salary</label>
                            <input type="text" id="view_basic_salary"  class="form-control form-control-sm" readonly="">
                        </div>
