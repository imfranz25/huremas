    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title"><b>Review Overtime Request</b></h4>
            ...
            <div class="modal-body">
              <form action="function/OT_review.php" method="POST">
                ...
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Total Hour(s)</label>
                  <div class="col-sm-9">
                      <input type="text" id="total" class="form-control form-control-sm" name="task" readonly="">
                    </div>
              </div>
              ...
              <div class="form-group row">
               ...
               <div class="form-group row" id="ottype" style="display: none;">
                  <label class="col-sm-3 col-form-label req">Overtime Type</label>
                      <div class="col-sm-9">
                          <select id="type" name="type" class="form-control border border-secondary">
                              <option value="">--Select--</option>

                              <?php 
                          $cats = $conn->query("SELECT * FROM overtime where status='active'");
                      while($row=$cats->fetch_assoc()):
                      ?>
                      <option value="<?php echo $row['id'] ?>" ><?php echo $row['overtime_name'] ?> (<?php echo $row['overtime_rate'] ?>%)</option>
                      <?php endwhile; ?>
                          </select>
                      </div>
              </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Total Hour(s)</label>
                  <div class="col-sm-9">
                      <input type="text" id="total1" class="form-control form-control-sm" name="task" readonly="">
                    </div>
              </div>
              ...
              <div class="form-group row">
               ...
               <div class="form-group row" id="ottype1">
                  <label class="col-sm-3 col-form-label">Overtime Type</label>
                      <div class="col-sm-9">
