          ...
          <div class="tab-content container">
            ...
            <div class="card tab-pane fade show active" id="hrreq_tab">
              ...
              <div class="card-header">
                ...
                <button type="button" class="btn btn-mat waves-effect waves-light btn-success m-0 float-right" data-target="#admin_request" data-toggle="modal" id="add_doc_req">
                  <i class="fa fa-plus"></i>Add Document Request
                </button>
              </div>   
              <div class="box-body pb-0">
                <div class="card-block table-border-style row text-justify">
        ...
        <div class="modal-body">
          <div class="text-center">
            ...
            <div class="text-center text-danger" >
              <label>
                <i class="fa fa-exclamation-circle mx-1" aria-hidden="true"></i> Once this request is cancelled, it can't be undone.
              </label>
            </div>
          </div>
        </div>
