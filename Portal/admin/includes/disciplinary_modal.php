    	  ...
    	  <div class="modal-body">
            ...
            <div class="col-sm-10">
              <select name="employee" class="form-control border border-secondary" id="selectEmp" required="" >
                ...
                ?>
  								<option value='<?php echo $row['employee_id']; ?>' data-pos='<?php echo $row['description']; ?>' data-dept='<?php echo $row['title']; ?>'>
                    <?php echo $row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'];  ?></option>
                <?php endwhile; ?>
              </select>
            </div>
          </div>
