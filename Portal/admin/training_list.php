                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-md-4">
                        <ul class="breadcrumb-title">
                          ...
                          <li class="breadcrumb-item">
                            <a href="training_list.php">Training</a>
                          </li>
                          <li class="breadcrumb-item">
                            <a href="training_list.php">Training List</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="pcoded-inner-content">
                  ...
                  <div class="card mb-0 ">    
                    <div class="card-header">
                      <h5>
                        <a class="btn btn-default reload_card" href="javascript:void(0)">Trainings / &nbsp;
                          <label id="tra_breadcrumb">All</label>
                        </a>                                  
                      </h5>
                      <div class="btn-group float-right">
                        <button type="button" class="btn btn-mat waves-effect waves-light btn-warning" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                      ...
                      <button type="button" class="btn btn-mat waves-effect waves-light btn-success float-right mx-2" data-toggle="modal" data-target="#trainingNew" id="btnTRA">
                          ...
                          <div class="card-header p-0 m-0 h-100">
                            ...
                            <div class="card-body row pt-4 pb-1">
                              <div class="col-12 col-sm-6">
                                <a type="button" class="btn bg-success text-white rounded f-13 p-2 manage" data-id="<?php echo $row['training_code']; ?>">
                                  <i class="fa fa-id-card mr-1"></i>Manage</a>
                              </div>
                            <div class="col-12 col-sm-6">
