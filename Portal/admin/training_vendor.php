                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-md-4">
                        <ul class="breadcrumb-title">
                          ...
                          <li class="breadcrumb-item">
                            <a href="training_vendor.php">Training</a>
                          </li>
                          <li class="breadcrumb-item">
                            <a href="training_vendor.php">Courses</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="pcoded-inner-content">
                  ...
                  <div class="card">
                    <div class="card-header">
                      ...
                      <button type="button" class="btn btn-mat waves-effect waves-light btn-success float-right" data-toggle="modal" data-target="#vendorNew" id="btnvendor">
