                                        ...
                                        ?>
                                            <tr>
                                                <td class="d-flex justify-content-center">
                                                    <a href='#view_req' data-toggle='modal' class='view_req' data-id='<?php echo $row['ca_id']; ?>'><i class='fa fa-eye'></i></a>
                                                </td>
                                                <td><?php echo $row['reference_id']; ?></td>
                                                <td><?php echo (new Datetime($row['req_date']))->format('F d, Y'); ?></td>
                                                <td><?php echo $row['firstname'].' '.$row['lastname']; ?></td>
                                                <td>
                                                    <button class='btn btn-success btn-sm review_req btn-round' data-id='<?php echo $row['ca_id']; ?>'><i class='fa fa-edit'></i> Review</button>
                                                </td>
                                            </tr>
