...
<head>
  ...
  <meta name="description" content="Forgot Password (HUREMAS) Portal" />
  <meta name="keywords" content="forgot password, password, forgot, huremas, cvsuic" />
...
<body style="background-image: url('assets/images/cvsubanner.jpg');background-repeat: no-repeat;background-size: 100% 250px;" >
  ...
  ?>
		<div class='callout callout-success text-center mt20'>
  		<b><p><?php echo $_SESSION['success']; ?></p></b>
  	</div>
