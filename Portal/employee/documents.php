                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="documents.php">Document Request</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                ...
                                <div class="sub-title"></div>
                                    ...
                                    <ul class="nav nav-tabs md-tabs" role="tablist">
                                        <li class="nav-item">
                                            ...
                                            <div class="mx-2 px-2 f-12 mt-2 badge badge-warning "><?php echo $emp_pending.' Pending'; ?></div> 
                                            <div class="mx-2 px-2 f-12 mt-2 badge badge-success"><?php echo $emp_replied.' Replied'; ?></div> 
                                            <div class="mx-2 px-2 f-12 mt-2 badge badge-danger"><?php echo $emp_rejected.' Rejected'; ?></div>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="mx-2 px-2 f-12 mt-2 badge badge-warning "><?php echo $hr_pending.' Pending'; ?></div>
                                            <div class="mx-2 px-2 f-12 mt-2 badge badge-success"><?php echo $hr_validated.' Validated'; ?></div>
                                            <div class="mx-2 px-2 f-12 mt-2 badge badge-danger"><?php echo $hr_rejected.' Rejected'; ?></div>
                                            </a>
