                                    ...
                                    <div class="d-inline-block align-middle">
                                      ...
                                      <div class="d-inline-block">
                                        ...
                                        <p class="text-muted m-b-0">
                                          <?php echo date_format($date_event,'d'); ?> <?php echo date_format($date_event,'F'); ?>
                                        </p>
                                      </div>
                                    </div>
                                  </td>
                                  <td>
                                    <?php echo date_format($date_from,"h:i A"); ?>
                                  </td>
                                  <td><?php echo date_format($date_to,"h:i A"); ?></td>
                                  <td class="text-right">
                                    <label><?php echo $row['event_venue']; ?></label>
                                  </td>
                                </tr>
                                <?php endwhile; endif; ?>
                              </tbody>
