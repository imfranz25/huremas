        ...
        <ul class="pcoded-item pcoded-left-item nav">
          ...
          <li>
            <a href="overtime.php" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="fa fa-clock-o"></i><b>FC</b>
              </span>
              <span class="pcoded-mtext" data-i18n="nav.form-components.main">
                Overtime
              </span>
          ...
          <li>
            <a href="official_business.php" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="fa fa-id-card-o"></i><b>FC</b>
              </span>
              <span class="pcoded-mtext" data-i18n="nav.form-components.main">
                Official Business
              </span>
          ...
          <li>
           ...
           <li>
            <a href="tasks.php" class="waves-effect waves-dark">
              <span class="pcoded-micon">
                <i class="ti-flag-alt-2"></i><b>FC</b>
              </span>
              <span class="pcoded-mtext" data-i18n="nav.form-components.main">
                Tasks
              </span>
