                                                    ...
                                                    ?>
                                                        <tr>
                                                          <td class="d-flex justify-content-center">
                                                            <a href='#view_tra' data-toggle='modal' class='view_tra' data-id='<?php echo $row['training_code']; ?>'><i class='fa fa-eye'></i></a>
                                                          </td>
                                                            <td><?php echo $row['training_code']; ?></td>
                                                            <td><?php echo $row['training_title']; ?></td>
                                                            <td><?php echo (new Datetime($row['schedule_from']))->format('F d, Y h:i a').' - '.(new Datetime($row['schedule_to']))->format('F d, Y h:i a'); ?></td>
