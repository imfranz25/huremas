                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class='btn btn-warning text-dark btn-sm review_req btn-round' data-id='<?php echo $row['reference_id']; ?>'><i class='fa fa-eye'></i> Review</button>
                                                    <?php 
                                                    if ($req_status==0) {
                                                    ?>
                                                    <button class='btn btn-success btn-sm edit_req btn-round' data-id='<?php echo $row['reference_id']; ?>'><i class='fa fa-edit'></i> Edit</button>
                                                      <button class='btn btn-danger btn-sm cancel_req btn-round' data-id='<?php echo $row['reference_id']; ?>'><i class='fa fa-ban'></i> Cancel</button>
                                                    <?php } ?>
