<div class="card">
  <div class="card-header">
    ...
    <button type="button" class="btn btn-mat waves-effect waves-light btn-success pull-right" data-toggle="modal" data-target="#emp_request">
      <i class="fa fa-plus"></i>Request Document
    </button>
  </div>
  <div class="box-body">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="dropdown-menu" style="">
                  <a class="dropdown-item review_req" href="javascript:void(0)" data-id="<?php echo $row['reference_id'] ?>">
                    <i class="fa fa-eye"></i>Review
                  </a>
                  <?php if ($req_status==0) { ?>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item edit_req" href="javascript:void(0)" data-id="<?php echo $row['reference_id'] ?>">
                      <i class="fa fa-edit"></i>Edit
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item cancel_req text-danger" href="javascript:void(0)" data-id="<?php echo $row['reference_id'] ?>">
